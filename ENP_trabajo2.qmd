...
Debido a la cantidad de datos, procederemos a calcular cada componente y desglosar la ecuación por partes para una mejor comprensión.
...
$$\frac{129 - 131}{143 -125}=\frac{-}{+}=-$$ $$\frac{129 - 142}{143 -123}=\frac{-}{+}=-$$ $$\frac{129 - 147}{143 -122}=\frac{-}{+}=-$$ $$\frac{129 - 151}{143 -120}=\frac{-}{+}=-$$ $$\frac{129 - 155}{143 -124}=\frac{-}{+}=-$$ $$\frac{129 - 158}{143 -123}=\frac{-}{+}=-$$ $$\frac{129 - 158}{143 -128}=\frac{-}{+}=-$$ $$\frac{129 - 183}{143 -115}=\frac{-}{+}=-$$ $$\frac{129 - 196}{143 -108}=\frac{-}{+}=-$$ **Concordancias=0** **Discordancias=9**

**Par (131,125)**

$$\frac{131 - 142}{125 -125}=\frac{-}{+}=-$$ $$\frac{131 - 1123}{125 -123}=\frac{-}{+}=-$$ $$\frac{131 - 147}{125 -122}=\frac{-}{+}=-$$ $$\frac{131 - 151}{125 -120}=\frac{-}{+}=-$$ $$\frac{131 - 155}{125 -124}=\frac{-}{+}=-$$ $$\frac{131 - 158}{125 -123}=\frac{-}{+}=-$$ $$\frac{131 - 158}{125 -128}=\frac{-}{-}=+$$ $$\frac{131 - 183}{125 -115}=\frac{-}{+}=-$$ $$\frac{131 - 196}{125 -108}=\frac{-}{+}=-$$

**Concordancias=1** **Discordancias=7**

**Par (142,123)**

$$\frac{142 - 147}{123 -122}=\frac{-}{+}=-$$ $$\frac{142 - 151}{123 -120}=\frac{-}{+}=-$$ $$\frac{142 - 155}{123 -124}=\frac{-}{-}=+$$ $$\frac{142 - 158}{123 -123}=\frac{-}{0}=0$$ $$\frac{142 - 158}{123 -128}=\frac{-}{-}=+$$ $$\frac{142 - 183}{123 -115}=\frac{-}{+}=-$$ $$\frac{142 - 196}{123 -108}=\frac{-}{+}=-$$

**Concordancias=2.5** **Discordancias=4.5**

**Par(147,122)** $$\frac{147 - 151}{122 -120}=\frac{-}{+}=-$$ $$\frac{147 - 155}{122 -124}=\frac{-}{-}=+$$ $$\frac{147 - 158}{122 -123}=\frac{-}{-}=+$$ $$\frac{147 - 158}{122 -128}=\frac{-}{-}=+$$ $$\frac{147 - 183}{122 -115}=\frac{-}{+}=-$$ $$\frac{147 - 196}{122 -108}=\frac{-}{+}=-$$

**Concordancias=3** **Discordancias=*3***

**Par(151,120)** $$\frac{151 - 155}{120 -124}=\frac{-}{-}=+$$ $$\frac{151 - 158}{120 -123}=\frac{-}{-}=+$$ $$\frac{151 - 158}{120 -128}=\frac{-}{-}=+$$ $$\frac{151 - 183}{120 -115}=\frac{-}{+}=-$$ $$\frac{151 - 196}{120 -108}=\frac{-}{+}=-$$

**Concordancias=3** **Discordancias=2**

**Par(155,124)**

$$\frac{155 - 158}{124 -123}=\frac{-}{+}=-$$ $$\frac{155 - 158}{124 -128}=\frac{-}{-}=+$$ $$\frac{155 - 183}{124 -115}=\frac{-}{+}=-$$ $$\frac{155 - 196}{124 -108}=\frac{-}{+}=-$$

**Concordancias=1** **Discordancias=3**

**Par(158,123)**

$$\frac{158 - 158}{123 -128}=\frac{0}{-}=0$$ $$\frac{158 - 183}{123 -115}=\frac{-}{+}=-$$ $$\frac{158 - 196}{123 -108}=\frac{-}{+}=-$$

**Concordancias=0.5** **Discordancias=2.5**

**Par(158,128)**

$$\frac{158 - 183}{128 -115}=\frac{-}{+}=-$$ $$\frac{158 - 196}{128 -108}=\frac{-}{+}=-$$
